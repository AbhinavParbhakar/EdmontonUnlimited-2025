...
function hideSubsearch() {
  setSubsearchHidden(true);
} 
function showSubsearch() {
  setSubsearchHidden(false);
}
    ...
    <div className="place-content-center">
        ...
        <div id="main-overlay" className="-z-98 absolute w-full h-25 pointer-events-none backdrop-blur-xs">
          ...
          <div className="p-5">
            ...
            <div onClick={showSubsearch} className="cursor-pointer m-1 pointer-events-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">What would you like to report?</div>
          </div>
        </div>
